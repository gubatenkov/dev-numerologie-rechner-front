		...
		numbers: [
			{
				...
				type: 'row',
				id: 'WZ',
				textShort: 'Diese Zahl zeigt eine Persönlichkeit, die viel Raum braucht, um sich zu entfalten. Es ist eine Persönlichkeit, die gerne im Mittelpunkt steht und einen wichtigen Beitrag für die Gesellschaft leisten möchte. Eine Herausforderung für diese Zahl ist es, zu lernen, dass sie wirklich auf sich achtet und Momente der Einsamkeit innerlich pflegt, um sich selbst authentisch wahrnehmen zu können.',
				result: {
					type: 'number',
					value: 19
				},
	...
	return {
		...
		numbers: [
			...
			},
			{
				...
				type: 'row',
				id: 'KL',
				textShort: 'Die Themen sind Macht, Selbstverwirklichung und Selbstständigkeit. Sie tragen das Bestreben, den „eigenen Weg“ gehen zu wollen, in sich. ',
				result: {
					type: 'list',
					values: [3, 6, 7]
				},
