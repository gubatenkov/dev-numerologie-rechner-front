...
class AnalysisResultPersonalRender extends Component {
  ...
  render() {
    ...
    const { analysis } = this.props.data.personalAnalysis;
      ...
      <div>
        ...
        <div className="ResultPersonalDataContainer">
          <div className="ResultPersonalData">
            ...
            {this.props.match.params.dateOfBirth && <h4>{this.props.match.params.dateOfBirth}</h4>}
          </div>
        </div>
...
export default AnalysisResultPersonalRender;
